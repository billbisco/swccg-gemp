...
public enum ModifierType {
    ...
    // Card stats
    DESTINY, DESTINY_INCREASE_LIMITED_TO, PRINTED_DESTINY, UNMODIFIABLE_DESTINY,
    POWER, POWER_INCREASE_LIMITED_TO, PRINTED_POWER, UNMODIFIABLE_POWER, MAY_NOT_HAVE_POWER_REDUCED, MAY_NOT_HAVE_POWER_INCREASED_BY_CARD,
    ...
    FORFEIT_VALUE, FORFEIT_INCREASE_LIMITED_TO, PRINTED_FORFEIT_VALUE, UNMODIFIABLE_FORFEIT_VALUE, MAY_NOT_HAVE_FORFEIT_VALUE_REDUCED, REMAINS_IN_PLAY_WHEN_FORFEITED, FORFEIT_VALUE_TO_USE, MAY_NOT_HAVE_FORFEIT_VALUE_INCREASED, MAY_NOT_HAVE_FORFEIT_VALUE_INCREASED_ABOVE_PRINTED,
    FEROCITY, PRINTED_FEROCITY, UNMODIFIABLE_FEROCITY, SUBTRACT_DESTINY_FROM_FEROCITY,
    ...
    LANDS_AS_UNLIMITED_MOVE_TO_LOCATION,
    ...
    MAY_NOT_SATISFY_ATTRITION, MAY_NOT_SATISFY_BATTLE_DAMAGE, SATISFIES_ALL_ATTRITION_WHEN_FORFEITED,
    ...
    FIRES_FOR_FREE, FIRE_WEAPON_FIRED_BY_FOR_FREE, MAY_FIRE_WEAPON_FIRED_BY_FOR_FREE,
    FIRES_FOR_DOUBLE,
    ...
    MAY_FIRE_REPEATEDLY_AT_SAME_TARGET_FOR_COST,
